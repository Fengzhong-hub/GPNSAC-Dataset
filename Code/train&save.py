...
if __name__ == '__main__':
    ...
    data, labels, min_values, max_values, label_encoders = load_data(file_path)  # Replace with your dataset path
    ...
    output_dim = 5  # Output data dimensions
